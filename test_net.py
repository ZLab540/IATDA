...
from model.faster_rcnn_npa_ac_sa_2tri.resnet import resnet
...
if __name__ == '__main__':
    ...
    for i in range(num_images):
        ...
        _,  rois_label, tgt_rois_label, _ = fasterRCNN(im_data, im_info, gt_boxes,
        ...
        if vis:
            if i % 20 == 0:
                cv2.imwrite(f'/media/disk4/hy/GPA/vis/ours/{i}.png', im2show)
            # pdb.set_trace()
