...
parser.add_argument('--test_mode', dest='test_mode',
                    help='baseline or IATDA',
                    default='GPA', type=str)
args = parser.parse_args()

for epoch in range(args.start_epoch, args.end_epoch + 1):
    if args.test_mode == 'IATDA':
        template = 'CUDA_VISIBLE_DEVICES={} python test_net.py --dataset {} --net {} --load_dir {} --model_config {} --checksession {} --checkepoch {} --checkpoint {} --cuda --pos_r {}'
